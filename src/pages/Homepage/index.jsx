    ...
    <>
      <div className="bg-gray-50 flex flex-col font-rubik sm:gap-10 md:gap-10 gap-[100px] items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-col items-center justify-start md:px-10 sm:px-5 px-[75px] w-full">
          <div className="flex flex-col gap-[46px] sm:items-baseline items-center justify-start sm:justify-start max-w-[1290px] mx-auto w-full">
        ...
        <div className="h-[535px] md:h-[892px] md:px-5 relative w-full">
          ...
          <div className="absolute flex md:flex-col flex-row md:gap-10 h-full inset-y-[0] items-center justify-between max-w-[1365px] my-auto right-[0] w-full">
            <div className="flex sm:flex-1 flex-col gap-[30px] items-start justify-start sm:m-auto w-[525px] sm:w-full">
              <div className="flex flex-col gap-[18px] items-start justify-start w-full">
                <Text
                  className="sm:m-[] sm:mb-[] sm:ml-[25px] sm:mr-[] sm:mt-[] text-2xl md:text-[22px] text-bluegray-900 sm:text-xl tracking-[-0.50px] w-full"
                  size="txtRubikRegular24"
                >
                  Interior Modern
                </Text>
                <Text
                  className="leading-[60.00px] sm:m-[] max-w-[525px] md:max-w-full sm:ml-[25px] sm:text-4xl md:text-[38px] text-[40px] text-black-900 tracking-[-0.50px]"
              ...
              <Button
                className="common-pointer border-2 border-bluegray-900 border-solid cursor-pointer font-medium leading-[normal] sm:m-[] min-w-[218px] sm:ml-[25px] py-[18px] text-bluegray-900 text-center text-xl tracking-[-0.50px]"
            ...
            <Img
              className="sm:flex-1 h-[535px] md:h-auto sm:m-auto object-cover w-[535px] sm:w-full"
