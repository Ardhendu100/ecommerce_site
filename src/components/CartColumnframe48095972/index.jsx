        ...
        <div className="flex md:flex-col flex-row gap-11 items-center justify-start w-full">
          <div className="flex flex-1 flex-col gap-10 items-start justify-start w-full">
            ...
            <div className="flex sm:flex-col flex-row gap-px items-start justify-start w-full">
              ...
              ></Input>
              <Button className="bg-bluegray-900 cursor-pointer font-bold font-rubik leading-[normal] sm:m-[] sm:mb-[] sm:ml-[] sm:mr-[] sm:mt-3 py-[23px] text-center text-lg text-yellow-100 tracking-[-0.50px] w-[157px]">
                {props?.subscribe}
              </Button>
            </div>
          </div>
